...
const copyItems: InternalChecklistItem[] = [
  createItem(1, "复印件", "签证申请表原件", "签字+复印件", false, "首页贴照片，末页申请人亲笔签名（中文加拼音）", [
    "首页粘贴护照照片",
    "末页申请人亲笔签名（中文加拼音），字迹跟护照页上的中文签名一致",
    "第12项拟在德国居留时间：居留开始时间应与VIDEX二维码文件中填写的入境日期一致",
    "居留结束时间为预计完成德国学业的时间",
  ]),
  createItem(2, "复印件", "《居留法》条款告知书", "签字+复印件", false, "申请人亲笔签名（中文加拼音）", [
  ...
  createItem(13, "复印件", "德文或英文留学动机说明", "签字", false, "申请人亲笔签名（中文加拼音）"),
